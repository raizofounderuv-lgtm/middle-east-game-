...
REGION_COORDS = {
    "مصر":      [(401,1025)],
    "تركيا":    [(462,416),(190,305)],
    "ايران":    [(1281,668)],
    "الاردن":   [(661,908)],
    "قطر":      [(1337,1189)],
    "الامارات": [(1483,1277)],
    "عمان":     [(1630,1414),(1551,1139)],
    "فلسطين":   [(582,867)],
    "الكويت":   [(1132,952)],
    "العراق":   [(951,770)],
    "السعودية": [(1077,1274)],
...
# ==================== المضائق ====================
STRAITS = {
    "هرمز":       {"controller":["عمان","ايران"],  "affects":["السعودية","الكويت","العراق","قطر","الامارات"], "blocked":False,"blocked_by":None},
...
REGIONAL_DISASTERS = [
    ...
    },
    {
        "name": "وباء إقليمي",
        "emoji": "🦠",
        "regions": ["مصر","اليمن","العراق","سوريا"],
    ...
    },
    {
        ...
        "emoji": "🌍",
        "regions": ["تركيا","سوريا","لبنان","فلسطين","قبرص","مصر"],
    ...
    },
    {
        ...
        "emoji": "🦗",
        "regions": ["اليمن","السعودية","عمان","مصر","الاردن"],
    ...
    },
    {
        ...
        "emoji": "📉",
        "regions": ["السعودية","الكويت","العراق","ايران","قطر","الامارات","عمان"],
    ...
    },
    {
        "name": "فيضانات الأنهر",
        "emoji": "🌊",
        "regions": ["العراق","سوريا","مصر","تركيا"],
        "effect": "facilities", "loss": (1, 2),
...
def generate_map(players, d):
    ...
    # ===== المضائق =====
    strait_pos = {"هرمز":(1556,1113),"باب المندب":(1044,1926),"السويس":(477,914),"البسفور":(252,311)}
